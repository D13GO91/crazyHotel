...
import { 
  ...
  AlertTriangle, ArrowRight, ShieldAlert, Award, MessageCircle
} from 'lucide-react';
  ...
  return (
    <div className="host-container">
      ...
      <div className="host-header">
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              background: showChat ? 'rgba(var(--accent-rgb), 0.22)' : 'rgba(255, 255, 255, 0.05)',
              border: `1px solid ${showChat ? 'var(--accent)' : 'rgba(255,255,255,0.1)'}`,
              color: showChat ? 'var(--accent-light)' : 'var(--text-muted)',
      ...
      <div style={{ display: 'flex', gap: '1.5rem', width: '100%', alignItems: 'stretch' }}>
        ...
        {showChat && (
          <div style={{ width: '320px', minWidth: '320px', display: 'flex', flexDirection: 'column', height: 'auto', maxHeight: '550px' }} className="animate-reveal">
